...
[![Go Report Card](https://goreportcard.com/badge/github.com/friendlycaptcha/hermes)](https://goreportcard.com/report/github.com/friendlycaptcha/hermes)
[![Godoc](https://godoc.org/github.com/friendlycaptcha/hermes?status.svg)](https://godoc.org/github.com/friendlycaptcha/hermes)
...
This is a fork of the original repository found [here](https://github.com/matcornic/hermes).
...
```
go get -u github.com/friendlycaptcha/hermes/v2
```
